	...
	*/
	class LA_Caption_Hover {
		...
		function render_menu_page(){
			...
			$pro_link = 'https://webdevocean.com/product/image-hover-effects-pro-plugin/';
			?>
			...
			<a style="text-decoration:none;"  href="https://webdevocean.com/product/image-hover-effects-pro-plugin/" target="_blank"><h4 style="border-radius: 20px;padding: 20px;background: #b72121;color: #fff;width: 40%;margin: 30px auto 0 auto;text-align:center;font-size:24px;">Now Unlock Pro Features Only in $10</h4></a>
			<p class="clearfix"></p>
